...
# BASE_URL = "https://chds.netlify.app/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Data science for everyone!"  # (translatable)
...
RSS_COPYRIGHT = 'Contents © {date} the authors {license}'
RSS_COPYRIGHT_PLAIN = 'Contents © {date} the authors {license}'
